...
',
  ...
  array (
    ...
    'Smo podjetje, ki je specializirano za opravljanje prevozov v Sloveniji in v tujini. Vedno urejeni vozniki z urejenimi vozili Vam nudijo kvaliteto storitev. Prevozi, ki jih opravljamo so lahko na določene destinacije ali kamorkoli na Vašo željo.' => 'Siamo una società specializzata nella fornitura di servizi di trasporto in Slovenia e all\'estero. Offriamo servizi di qualità con vetture di alto livello, guidate da autisti professionali e cortesi. I servizi che forniamo possono essere per destinazioni specifiche o dovunque su vostra richiesta.',
    'Galerijo vozil si lahko ogledate na naši spletni strani. Nudimo tudi enodnevne ali večdnevne najeme vozil z urejenimi vozniki, kateri Vas popeljejo po raznih opravkih ali  sestankih, Vas tam počakajo in na koncu dneva poskrbijo, da prispete varno domov ali v hotel.' => 'Offriamo una vasta scelta di servizi di autonoleggio con conducente, garantendo sempre vetture di alto livello, super accessoriate, guidate da autisti della massima serietà e professionalità.Garantiamo tempi di risposta rapidi in base alle vostre esigenze. Le nostre vetture sono dotate di tutti i comfort per farvi viaggiare in tranquillità e comodità.',
