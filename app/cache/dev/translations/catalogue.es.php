...
',
  ...
  array (
    ...
    'Smo podjetje, ki je specializirano za opravljanje prevozov v Sloveniji in v tujini. Vedno urejeni vozniki z urejenimi vozili Vam nudijo kvaliteto storitev. Prevozi, ki jih opravljamo so lahko na določene destinacije ali kamorkoli na Vašo željo.' => 'Nuestra empresa es una empresa especializada en realizar viajes por Eslovenia y en el extranjero. Los conductores, siempre bien vestidos y con sus vehículos siempre limpios, les ofrecerán un servicio de excelente calidad. El transporte puede ser a cualquier de los destinos que nosotros les ofrecemos, a o al destino deseado por usted.',
    'Galerijo vozil si lahko ogledate na naši spletni strani. Nudimo tudi enodnevne ali večdnevne najeme vozil z urejenimi vozniki, kateri Vas popeljejo po raznih opravkih ali  sestankih, Vas tam počakajo in na koncu dneva poskrbijo, da prispete varno domov ali v hotel.' => 'Garantizamos una respuesta rápida y acorde a sus necesidades.Con nosotros viajará siempre tranquilo y cómodo, ya que disponemos de vehículos de alta gama, equipados con los mejores sistemas de seguridad, y conductores experimentados. En la sección de Galería, puede ver nuestros vehículos.',
