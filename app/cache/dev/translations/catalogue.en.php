...
',
  ...
  array (
    ...
    'Novice' => 'News',
    'Izleti' => 'Tours',
    'Povpraševanje' => 'Inquiry',
    'Galerija' => 'Galery',
    'Galerija slik' => 'Photo galery',
    'Video galerija' => 'Video galery',
    'Kontakt' => 'Contact',
    'Elektronska pošta' => 'Email',
    'Shrani' => 'Save',
    'Naročilo' => 'Order',
    'Naročilo transporta' => 'Transport order',
    'Pošlji' => 'Send',
    'Naroči' => 'Order',
    'Nazaj' => 'Back',
    'Več' => 'More',
    'Ponujamo izlet na naslednjo destinacijo' => 'We offer a trip to the next destination',
    'V izdelavi' => 'Under construction',
    'Ime' => 'Name',
    'Podjetje' => 'Company',
    'Telefon' => 'Phone',
    'Email' => 'E-mail',
    'Vnos besedila' => 'Insert text',
    'Dobrodošli na naši spletni strani' => 'Welcome to our web page',
    'Smo podjetje, ki je specializirano za opravljanje prevozov v Sloveniji in v tujini. Vedno urejeni vozniki z urejenimi vozili Vam nudijo kvaliteto storitev. Prevozi, ki jih opravljamo so lahko na določene destinacije ali kamorkoli na Vašo željo.' => 'We are a company that specializes in the performance of transport services in Slovenia and abroad. Always arranged drivers with tended vehicles we offer quality services. Services which we provide can be to specific places or anywhere on your request.',
    'Zagotavljamo hitro odzivnost glede na Vaše potrebe.' => 'We guarantee fast response time according to your needs.',
    'Z našimi vozili bo vožnja vedno udobna in varna, saj vozila spadajo v višji cenovni razred, prav tako pa tudi v najvišji razred varnosti.' => 'Jurney with our vehicles will always be comfortable and safe because our vheicles belonging to the higher price range, as well as the highest class of security.',
    'Galerijo vozil si lahko ogledate na naši spletni strani. Nudimo tudi enodnevne ali večdnevne najeme vozil z urejenimi vozniki, kateri Vas popeljejo po raznih opravkih ali  sestankih, Vas tam počakajo in na koncu dneva poskrbijo, da prispete varno domov ali v hotel.' => 'Gallery of vehicles can be viewed on our website. We also offer one-day or multi-day rentals of vehicles with tended drivers, which takes you to the various errands or meetings, wait you there and at the end of the day make sure that you arrive home or in a hotel safely.',
    'Organiziramo tudi izlete po raznih krajih v Sloveniji. Naš voznik Vas na kraju počaka in Vas varno pripelje tudi nazaj. Kraje in zanimive destinacije si lahko ogledate na naši spletni strani.' => 'We also organize tours in various places in Slovenia. Our driver waits for you on the spot and bring you safely back again. Places and interesting destinations you can look at our website.',
    'Za vse informacije nas lahko kontaktirate preko telefona ali elektronske pošte. V najkrajšem možnem času Vas bomo kontaktirali in Vam posredovali željene informacije.' => 'For all additional information you can contact us via phone or email. As soon as possible we will contact you and provide you with the required informations.',
    'Zahvaljujemo se Vam za obisk naše spletne strani.' => 'Thank you for visiting our website.',
  ),
));
