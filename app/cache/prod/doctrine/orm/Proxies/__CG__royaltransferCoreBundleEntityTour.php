...
namespace Proxies\__CG__\royaltransfer\CoreBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Tour extends \royaltransfer\CoreBundle\Entity\Tour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'description', 'file', 'path', 'size', 'video', 'created', 'modified');
        }
    ...
    public function setModified()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setModified', array());
