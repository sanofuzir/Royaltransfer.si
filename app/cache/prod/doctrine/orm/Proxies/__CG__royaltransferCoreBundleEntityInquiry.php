 ...
 */
class Inquiry extends \royaltransfer\CoreBundle\Entity\Inquiry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '_statuses', 'id', 'name', 'company', 'telephone', 'email', 'status', 'text', 'created');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Inquiry $proxy) {
