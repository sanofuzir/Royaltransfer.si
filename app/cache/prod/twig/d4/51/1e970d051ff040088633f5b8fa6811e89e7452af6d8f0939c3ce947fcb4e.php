...
class __TwigTemplate_d4511e970d051ff040088633f5b8fa6811e89e7452af6d8f0939c3ce947fcb4e extends Twig_Template
{
    ...
    {
        echo $this->env->getExtension('translator')->getTranslator()->trans("Naročilo", array(), "messages");
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 6
        echo "<h1 class=\"title\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("Naročilo transporta", array(), "messages");
        echo "</h1>
<form class=\"order_form\" action=\"";
        // line 7
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "id")) ? ($this->env->getExtension('routing')->getPath("_edit_order", array("id" => $this->getAttribute((isset($context["order"]) ? $context["order"] : null), "id")))) : ($this->env->getExtension('routing')->getPath("_add_order"))), "html", null, true);
        echo "\" method=\"post\" ";
    ...
    <!--div class=\"form-actions\"-->
        <br />
        <input type=\"submit\" name=\"naroči\" value=\"";
        // line 11
        echo $this->env->getExtension('translator')->getTranslator()->trans("Naroči", array(), "messages");
