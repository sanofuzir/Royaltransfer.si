...
class __TwigTemplate_dba9010d4080a82c5ec95d687e809d81304cbd082fa2d6e8505172859f77180e extends Twig_Template
{
...
";
        // line 8
        if ((!twig_test_empty((isset($context["tours"]) ? $context["tours"] : null)))) {
            // line 9
            echo "    ";
            ...
            <tr>
                ...
                echo "
                    ...
                    <p class=\"link\">
                        <a href=\"";
                // line 21
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_single_tour", array("id" => $this->getAttribute((isset($context["item"]) ? $context["item"] : null), "id"))), "html", null, true);
                echo "\" >";
