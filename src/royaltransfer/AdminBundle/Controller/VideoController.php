...
class VideoController extends Controller
{
    ...
    /**
     * @Route("/admin/videos", name="_admin_videos")
     * @Template()
     */
    ...
    /**
     * @Route("/admin/video/delete/{id}", name="_admin_delete_video", requirements={"id" = "\d+"})
     */
    ...
    /**
     * @Route("/admin/video/add", name="_admin_add_video")
     * @Route("/admin/video/edit/{id}", name="_admin_edit_video", requirements={"id" = "\d+"})
     * @Template()
     */
